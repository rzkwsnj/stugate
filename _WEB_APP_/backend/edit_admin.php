...
if (isset($_SESSION['role']) and $_SESSION['role'] == 'superuser') {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "GET") {
        ...
        $query = mysqli_query($con, "SELECT * FROM admins WHERE admin_id='$get_id'");
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = mysqli_query($con, "Update admins SET admin_name='$admin_name',admin_email='$admin_email',admin_cell='$admin_phone',admin_address='$admin_address',admin_password='$pass' WHERE admin_id='$admin_id'");
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-check-square-o"></i> Edit Admin
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <form role="form" id="quickForm" method="post" action="edit_admin.php">
                            <div class="panel-body">

                                <div class="form-group">

                                    <input type="hidden" name="admin_id" class="form-control" id="exampleInputAdminName"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="admin_password" class="form-control"
                                           ...
                                           value="<?php echo valueEncryptDecrypt('decrypt', $row['admin_password']); ?>">
                                </div>


                            </div>
                            <div class="panel-footer">
                                <button type="submit" id="update_admin" class="btn btn-primary"><i
                                            class="fa fa-check-circle"></i> Update Admin
                                </button>
                            </div>
                        </form>
