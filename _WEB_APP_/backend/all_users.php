            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-check-square-o"></i> All Users
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <button type="button" onclick="location.href = 'add_user.php';"
                                    class="btn btn-primary float-right"><i class='fa fa-plus-circle'></i> Add User
                            </button>
                        </div>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    if ($row['user_status'] == 0) {
                                        echo "<td><a class='btn btn-success'  href=\"active_user.php?id=" . $row['id'] . "\" ><i class='fa fa-check-circle'></i> Active</a></td> ";
                                    } else {
                                        echo "<td><a class='btn btn-danger'  href=\"inactive_user.php?id=" . $row['id'] . "\" ><i class='fa fa-times-circle'></i> Inactive</a></td> ";
                                    }


                                    echo "<td><a class='btn btn-primary'  href=\"edit_user.php?id=" . $row['id'] . "\" ><i class='fa fa-edit'></i></a>  ";
                                    echo "<a class='confirmation btn btn-danger'  href=\"delete_user.php?id=" . $row['id'] . "\" ><i class='fa fa-trash'></i></a></td>";
