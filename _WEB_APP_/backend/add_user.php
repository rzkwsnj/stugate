...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $result = mysqli_query($con, "SELECT * FROM users where email='$email' OR cell='$phone'");
    $num_rows = mysqli_num_rows($result);


    if ($num_rows > 0) {
        echo '<script type="text/javascript">';
        echo 'setTimeout(function () { swal("ERROR!","User email or phone already exists!","error");';
        echo '}, 500);</script>';
    } else {
        $pass = valueEncryptDecrypt('encrypt', $password);
        if (mysqli_query($con, "INSERT INTO users (`name`,`email`,`cell`,`user_type`,`password`) VALUE ('$name','$email','$phone','$type','$pass')")) {
            echo '<script type="text/javascript">';
            echo 'setTimeout(function () { swal("User Successfully Added!","Done!","success");';
            echo '}, 500);</script>';
                        ...
                        <form role="form" id="quickForm" method="post" action="add_admin.php">
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputAdminName">Name</label>
                                    <input type="text" name="name" class="form-control" id="exampleInputAdminName"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleStudentDepartment">Role</label>
                                        <select class="form-control" name="type" id="exampleStudentDepartment">
                            ...
                            <div class="panel-footer">
                                ...
                                <button type="submit" id="add_user" class="btn btn-primary"><i
                                            class="fa fa-check-circle"></i> Add User
                                </button>
                            </div>
                        </form>
