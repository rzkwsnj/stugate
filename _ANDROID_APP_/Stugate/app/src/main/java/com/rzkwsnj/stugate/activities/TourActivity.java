...
import com.rzkwsnj.stugate.sessions.TourPrefManager;
...
public class TourActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        session = new SessionHelper(TourActivity.this);
        if (session.getBoolean(Config.IS_USER_LOGIN)) {
            launchHomeScreen();
        } else {
            // Checking for first time launch - before calling setContentView()
            TourPrefManager prefManager = new TourPrefManager(this);
        ...
        layouts = new int[]{
                R.layout.tour_slide_1,
                R.layout.tour_slide_2,
                R.layout.tour_slide_3,
                R.layout.tour_slide_4};
    ...
    private void launchHomeScreen() {
        // prefManager.setFirstTimeLaunch(false); // THIS IS FOR SET FIRST TIME !!!
